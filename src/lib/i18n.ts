export const translations = {
  ko: {
    ...
    placeholder: "이름을 입력하세요 (예: Caroline Kim)",
  ...
  en: {
    ...
    placeholder: "Type your name, like Caroline Smith",
  ...
  zh: {
    ...
    placeholder: "输入你的名字，例如 Caroline Wang",
  ...
  ja: {
    ...
    placeholder: "名前を入力してください（例: Caroline Sato）",
  ...
  es: {
    ...
    placeholder: "Escribe tu nombre, p. ej. Caroline García",
  ...
  fr: {
    ...
    placeholder: "Saisissez votre nom, ex. Caroline Martin",
  ...
  de: {
    ...
    placeholder: "Tippe deinen Namen, z. B. Caroline Müller",
  ...
  ar: {
    ...
    placeholder: "اكتب اسمك، مثل Caroline Hassan",
  ...
  ru: {
    ...
    placeholder: "Введите имя, напр. Caroline Ivanova",
  ...
  pt: {
    ...
    placeholder: "Digite seu nome, ex. Caroline Silva",
  ...
  vi: {
    ...
    placeholder: "Nhập tên của bạn, ví dụ Caroline Nguyen",
  ...
  id: {
    ...
    placeholder: "Ketik nama Anda, mis. Caroline Wijaya",
  ...
  th: {
    ...
    placeholder: "พิมพ์ชื่อของคุณ เช่น Caroline Saetang",
  ...
  ms: {
    ...
    placeholder: "Taip nama anda, cth. Caroline Abdullah",
  ...
  hi: {
    ...
    placeholder: "अपना नाम लिखें, जैसे Caroline Sharma",
  ...
  bn: {
    ...
    placeholder: "আপনার নাম টাইপ করুন, যেমন Caroline Das",
  ...
  tl: {
    ...
    placeholder: "I-type ang pangalan mo, hal. Caroline Santos",
  ...
  my: {
    ...
    placeholder: "သင့်နာမည်ကို ရိုက်ထည့်ပါ (ဥပမာ Caroline Aung)",
  ...
  mn: {
    ...
    placeholder: "Нэрээ бичнэ үү, жнь Caroline Bat",
