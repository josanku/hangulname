export const translations = {
  ko: {
    ...
    placeholder: "이름을 입력하세요 (예: Caroline)",
  ...
  en: {
    ...
    placeholder: "Type your name, like Caroline",
  ...
  zh: {
    ...
    placeholder: "输入你的名字，例如 Caroline",
  ...
  ja: {
    ...
    placeholder: "名前を入力してください（例: Caroline）",
  ...
  es: {
    ...
    placeholder: "Escribe tu nombre, p. ej. Caroline",
  ...
  fr: {
    ...
    placeholder: "Saisissez votre nom, ex. Caroline",
  ...
  de: {
    ...
    placeholder: "Tippe deinen Namen, z. B. Caroline",
  ...
  ar: {
    ...
    placeholder: "اكتب اسمك، مثل Caroline",
  ...
  ru: {
    ...
    placeholder: "Введите имя, напр. Caroline",
  ...
  pt: {
    ...
    placeholder: "Digite seu nome, ex. Caroline",
  ...
  vi: {
    ...
    placeholder: "Nhập tên của bạn, ví dụ Caroline",
  ...
  id: {
    ...
    placeholder: "Ketik nama Anda, mis. Caroline",
  ...
  th: {
    ...
    placeholder: "พิมพ์ชื่อของคุณ เช่น Caroline",
  ...
  ms: {
    ...
    placeholder: "Taip nama anda, cth. Caroline",
  ...
  hi: {
    ...
    placeholder: "अपना नाम लिखें, जैसे Caroline",
  ...
  bn: {
    ...
    placeholder: "আপনার নাম টাইপ করুন, যেমন Caroline",
  ...
  tl: {
    ...
    placeholder: "I-type ang pangalan mo, hal. Caroline",
  ...
  my: {
    ...
    placeholder: "သင့်နာမည်ကို ရိုက်ထည့်ပါ (ဥပမာ Caroline)",
  ...
  mn: {
    ...
    placeholder: "Нэрээ бичнэ үү, жнь Caroline",
